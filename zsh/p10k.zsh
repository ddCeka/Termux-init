# Generated by Powerlevel10k configuration wizard on 2026-06-07 at 22:39 WIB.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='RF'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_EXPANSION='󰢕'
  # Custom prefix.
